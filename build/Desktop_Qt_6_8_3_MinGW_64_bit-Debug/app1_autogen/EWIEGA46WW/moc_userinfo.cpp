...
namespace {
struct qt_meta_tag_ZN8USERINFOE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8USERINFOE = QtMocHelpers::stringData(
    "USERINFO",
    "loadRegisteredInfo",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8USERINFOE[] = {
...
Q_CONSTINIT const QMetaObject USERINFO::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8USERINFOE.offsetsAndSizes,
    qt_meta_data_ZN8USERINFOE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8USERINFOE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<USERINFO, std::true_type>,
        // method 'loadRegisteredInfo'
...
void USERINFO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loadRegisteredInfo(); break;
...
void *USERINFO::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8USERINFOE.stringdata0))
