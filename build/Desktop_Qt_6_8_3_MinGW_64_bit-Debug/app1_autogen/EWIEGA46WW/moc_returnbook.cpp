...
namespace {
struct qt_meta_tag_ZN10returnbookE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10returnbookE = QtMocHelpers::stringData(
    "returnbook",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10returnbookE[] = {
...
Q_CONSTINIT const QMetaObject returnbook::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10returnbookE.offsetsAndSizes,
    qt_meta_data_ZN10returnbookE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10returnbookE_t,
        // Q_OBJECT / Q_GADGET
...
void *returnbook::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10returnbookE.stringdata0))
